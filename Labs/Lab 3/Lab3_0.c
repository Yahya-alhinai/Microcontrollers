...
// initialize Display Variables to be OFF  
   ...
   while (1)
    {
        ...
        // The right and the left digit!
        if (alternate)
            LATB |= 0b0000010000000000 | digit[0]; // The left digit
        else
            LATB |= 0b0000100000000000 | digit[1]; // The right digit
