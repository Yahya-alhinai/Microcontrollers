...
int main()
{
    ...
    Send_write("1: CHANGE THE STATE");
    Send_write("2: Increment temperature");
    Send_write("3: Decrement temperature");
    Send_write("4: Change temperature unit");
    Send_write("5: Turn ON/OFF");
